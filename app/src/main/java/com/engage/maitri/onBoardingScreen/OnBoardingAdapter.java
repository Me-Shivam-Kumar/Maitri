package com.engage.maitri.onBoardingScreen;
...
import com.engage.maitri.R;

import java.util.List;

public class OnBoardingAdapter extends RecyclerView.Adapter<com.engage.maitri.onBoardingScreen.OnBoardingAdapter.OnBoardingViewHolder>{
